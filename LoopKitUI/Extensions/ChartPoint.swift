...
extension TargetChartBar {
    static func barsForGlucoseRangeSchedule(_ glucoseRangeSchedule: GlucoseRangeSchedule, unit: HKUnit, chartStartDate: Date, chartEndDate: Date, considering potentialOverride: TemporaryScheduleOverride? = nil) -> [TargetChartBar] {
    ...
    static fileprivate func createBar(value: ClosedRange<HKQuantity>, unit: HKUnit, startDate: Date, endDate: Date, isOverride: Bool) -> TargetChartBar? {
    ...
    static func barForGlucoseRangeScheduleOverride(_ override: TemporaryScheduleOverride, unit: HKUnit, chartEndDate: Date, extendEndDateToChart: Bool = false) -> TargetChartBar? {
